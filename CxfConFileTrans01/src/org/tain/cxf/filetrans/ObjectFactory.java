 ...
 * generated in the org.tain.cxf.filetrans package. 
...
public class ObjectFactory {
    ...
    private final static QName _DownloadResponse_QNAME = new QName("http://filetrans.cxf.tain.org/", "downloadResponse");
    private final static QName _Upload_QNAME = new QName("http://filetrans.cxf.tain.org/", "upload");
    private final static QName _Download_QNAME = new QName("http://filetrans.cxf.tain.org/", "download");
    private final static QName _UploadResponse_QNAME = new QName("http://filetrans.cxf.tain.org/", "uploadResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.tain.cxf.filetrans
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://filetrans.cxf.tain.org/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://filetrans.cxf.tain.org/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://filetrans.cxf.tain.org/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://filetrans.cxf.tain.org/", name = "uploadResponse")
