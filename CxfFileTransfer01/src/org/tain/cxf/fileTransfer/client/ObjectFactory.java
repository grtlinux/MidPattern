 ...
 * generated in the org.tain.cxf.filetransfer.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _UploadFile_QNAME = new QName("http://fileTransfer.cxf.tain.org/", "uploadFile");
    private final static QName _UploadFileResponse_QNAME = new QName("http://fileTransfer.cxf.tain.org/", "uploadFileResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.tain.cxf.filetransfer.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileTransfer.cxf.tain.org/", name = "uploadFile")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileTransfer.cxf.tain.org/", name = "uploadFileResponse")
