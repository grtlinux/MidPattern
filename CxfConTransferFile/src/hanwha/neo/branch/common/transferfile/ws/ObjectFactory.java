 ...
 * generated in the hanwha.neo.branch.common.transferfile.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://ws.transferfile.common.branch.neo.hanwha/", "download");
    private final static QName _DownloadResponse_QNAME = new QName("http://ws.transferfile.common.branch.neo.hanwha/", "downloadResponse");
    private final static QName _Upload_QNAME = new QName("http://ws.transferfile.common.branch.neo.hanwha/", "upload");
    private final static QName _UploadResponse_QNAME = new QName("http://ws.transferfile.common.branch.neo.hanwha/", "uploadResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: hanwha.neo.branch.common.transferfile.ws
     * 
     */
    ...
    /**
     * Create an instance of {@link TransferFile }
     * 
     */
    public TransferFile createTransferFile() {
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.transferfile.common.branch.neo.hanwha/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.transferfile.common.branch.neo.hanwha/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.transferfile.common.branch.neo.hanwha/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.transferfile.common.branch.neo.hanwha/", name = "uploadResponse")
