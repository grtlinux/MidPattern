...
class AppClient05 implements OmmConsumerClient {
	...
	public AppClient05(String _udpHost, String _udpPort) {
...
public class MRNConsumer05 {
	...
	private static AppClient05 _appClient;

	public MRNConsumer05(String[] args) throws Exception {
		...
		try {
			_appClient = new AppClient05(_udpHost, _udpPort);
	...
	public static void main(String[] args) throws Exception {
		...
		if (flag) {
	    	//args = new String[] { "159.220.246.3",   "8101", "hEDD", "TY6_03_RHB_KR02895", "127.0.0.1", "1234" };
	    	args = new String[] { "159.220.246.3",  "14002", "hEDD", "TY6_03_RHB_KR02895", "127.0.0.1", "1234" };
	    	//args = new String[] { "159.220.246.19",  "8101", "hEDD", "TY6_03_RHB_KR02895", "127.0.0.1", "1234" };
	    	//args = new String[] { "159.220.246.19", "14002", "hEDD", "TY6_03_RHB_KR02895", "127.0.0.1", "1234" };
		}

    	new MRNConsumer05(args);
	}
}
