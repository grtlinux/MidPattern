...
public class ObjectFactory {
    ...
    private final static QName _UploadResponse_QNAME = new QName("http://provider.filetransfer.cxf.tain.org/", "uploadResponse");
    private final static QName _Upload_QNAME = new QName("http://provider.filetransfer.cxf.tain.org/", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://provider.filetransfer.cxf.tain.org/", "downloadResponse");
    private final static QName _Download_QNAME = new QName("http://provider.filetransfer.cxf.tain.org/", "download");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.filetransfer.cxf.tain.org/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.filetransfer.cxf.tain.org/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.filetransfer.cxf.tain.org/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.filetransfer.cxf.tain.org/", name = "download")
